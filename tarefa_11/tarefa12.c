/*
Tarefa 11:
Escreva um código que simule o movimento
...
velocidade do fluido no tempo. Inicialize o
fluido parado ou com velocidade constante
e verifique se o campo permanece estável.
Em seguida, crie uma pequena perturbação
e observe se ela se difunde suavemente.
Após validar o código, paralelize-o com
OpenMP e explore o impacto das cláusulas
schedule e collapse no desempenho
...
int main() {
    ...
    fclose(outfile);
    printf("Simulação completa. Dados salvos em fluid3d_simulation.bin\n");
